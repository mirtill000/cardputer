...
// "NETRUNNER" home screen (Fase 56, TERMINAL tile removed in Fase 57):
// the entry point BootScreen hands off to, replacing the old flat top-
// level list. Two big navigable tiles - WIFI TOOLS on the left,
// BLUETOOTH TOOLS on the right - plus footer hotkeys for SETTINGS and
// ABOUT. Same tile language as the mockup the user supplied; scaled to
// the real 240x135 display instead of the 1080x600 mockup canvas.
...
private:
    enum class Tile : uint8_t { Wifi = 0, Bluetooth = 1 };
